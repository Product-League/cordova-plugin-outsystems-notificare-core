...
module.exports = function(context) {
  ...
  if (!notificareServicesZipFile) {
    throw new Error("No configuration zip file found (notificare-services-zip). You can check how to configure this file at: https://github.com/kelter-antunes/cordova-plugin-outsystems-notificare/blob/main/CONFIG.md");
  }
